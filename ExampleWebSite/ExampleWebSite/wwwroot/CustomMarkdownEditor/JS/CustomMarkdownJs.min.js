function insertTextAtCursor(n,t,i){var e=n.value,r,u,f=n.ownerDocument;typeof n.selectionStart=="number"&&typeof n.selectionEnd=="number"?(r=n.selectionEnd,n.value=e.slice(0,r)+t+e.slice(r),n.selectionStart=n.selectionEnd=r+t.length+(i?i:0)):f.selection!="undefined"&&f.selection.createRange&&(n.focus(),u=f.selection.createRange(),u.collapse(!1),u.text=t,u.select())}$(document).ready(function(){$("#MarkdownEditor").html(`<div class=" m-auto btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
